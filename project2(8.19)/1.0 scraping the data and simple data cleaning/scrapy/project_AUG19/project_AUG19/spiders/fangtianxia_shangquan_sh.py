...
class LianjiaershoubjSpider(CrawlSpider):
    name = 'fangtianxiashangquansh'
    allowed_domains = ['sh.shop.fang.com']
    start_urls = ['https://sh.shop.fang.com/shou/house/i31/']
    ua = UserAgent()
    ...
    def parse(self, response):
        ...
        urlstring = 'https://sh.shop.fang.com/shou/house/' 
    ...
    def parse_small(self, response):
        for link in response.xpath("//dt[@class = 'floatl']//a/@href").extract():
            ...
            totallink = 'https://sh.shop.fang.com'+ str(link)
