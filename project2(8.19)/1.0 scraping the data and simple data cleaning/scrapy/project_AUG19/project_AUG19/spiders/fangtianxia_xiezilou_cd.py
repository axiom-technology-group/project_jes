...
class LianjiaershoubjSpider(CrawlSpider):
    name = 'fangtianxiaxieziloucd'
    allowed_domains = ['cd.office.fang.com']
    start_urls = ['https://cd.office.fang.com/shou/house/i31/']
    ua = UserAgent()
    ...
    def parse_small(self, response):
        ...
        for link in response.xpath("//p[@class = 'title']//a/@href").extract():
            ...
            totallink = 'https://cd.office.fang.com'+ str(link)
