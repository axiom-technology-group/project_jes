...
class LianjiaershoubjSpider(CrawlSpider):
    name = 'fangtianxiashangquangz'
    allowed_domains = ['gz.shop.fang.com']
    start_urls = ['https://gz.shop.fang.com/shou/house/i31/']
    ua = UserAgent()
    ...
    def parse(self, response):
        ...
        lst = ["d250",]
        lst = ["c50-d2100","c2100-d2150",]
       
        lst = ["c2200-d2300","c2300-d2500"]
        
        lst = ["c2500-d2800",]
        lst = ["c2800-d21000",]
        lst = ["c21000"]

        urlstring = 'https://gz.shop.fang.com/shou/house/' 
