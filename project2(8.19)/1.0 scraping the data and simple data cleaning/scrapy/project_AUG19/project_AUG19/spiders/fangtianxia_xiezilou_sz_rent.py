...
class LianjiaerszoubjSpider(CrawlSpider):
    name = 'fangtianxiaxiezilouszrent'
    allowed_domains = ['sz.office.fang.com']
    start_urls = ['https://sz.office.fang.com/zu/house/i31/']
    ua = UserAgent()
    ...
    def parse(self, response):
        ...
        URLs = ['https://sz.office.fang.com/zu/house/c1200-i31/']
        url = 'https://sz.office.fang.com/zu/house/'
    ...
    def parse_small(self, response):
        ...
        for link in response.xpath("//p[@class = 'title']//a/@href").extract():
            ...
            totallink = 'https://sz.office.fang.com'+ str(link)
