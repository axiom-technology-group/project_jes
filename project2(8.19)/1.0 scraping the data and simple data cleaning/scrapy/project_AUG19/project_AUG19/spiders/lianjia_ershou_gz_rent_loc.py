...
class LianjiaershouSpider(CrawlSpider):
    name = 'lianjiaershourentgzloc'
    allowed_domains = ['gz.lianjia.com']
    start_urls = ['https://gz.lianjia.com/zufang/pg1']
    headers={
    ...
    def parse(self, response):
        ...
        lst = ['brp50000']
        jump = 200
        for j in range(0,50000,jump):
 
            lst.append('brp'+ str(j) + 'erp' + str(j+jump))


        urlstring = 'https://gz.lianjia.com/zufang/pg1' 
    ...
    def parse_small(self, response):
        ...
        for link in locationlinkraw:
            locationlink.append('https://gz.lianjia.com' + link)
