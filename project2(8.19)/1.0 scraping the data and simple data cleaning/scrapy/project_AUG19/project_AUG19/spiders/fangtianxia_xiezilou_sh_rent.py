...
class LianjiaershoubjSpider(CrawlSpider):
    name = 'fangtianxiaxieziloushrent'
    allowed_domains = ['sh.office.fang.com']
    start_urls = ['https://sh.office.fang.com/zu/house/i31/']
    ua = UserAgent()
    ...
    def parse(self, response):
        ...
        URLs = ['https://sh.office.fang.com/zu/house/c125-i31/']
        url = 'https://sh.office.fang.com/zu/house/'
