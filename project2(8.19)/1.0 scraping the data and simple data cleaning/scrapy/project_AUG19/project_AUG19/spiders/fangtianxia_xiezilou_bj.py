...
class LianjiaershoubjSpider(CrawlSpider):
    name = 'fangtianxiaxieziloubj'
    allowed_domains = ['office.fang.com']
    start_urls = ['https://office.fang.com/shou/house/i31/']
    ua = UserAgent()
    ...
    def parse_small(self, response):
        ...
        for link in response.xpath("//p[@class = 'title']//a/@href").extract():
            ...
            totallink = 'https://office.fang.com'+ str(link)
