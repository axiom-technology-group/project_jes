...
class LianjiaershoucdSpider(CrawlSpider):
    name = 'lianjiaershoucd'
    allowed_domains = ['cd.lianjia.com']
    start_urls = ['https://cd.lianjia.com/chengjiao/pg1']
    headers={
    ...
    def parse(self, response):
        ...
        urlstring = 'https://cd.lianjia.com/chengjiao/pg1' 
