...
class LianjiaershoubjSpider(CrawlSpider):
    name = 'fangtianxiaxieziloucdrent'
    allowed_domains = ['cd.office.fang.com']
    start_urls = ['https://cd.office.fang.com/zu/house/i31/']
    ua = UserAgent()
    ...
    def parse(self, response):
        ...
        URLs = ['https://cd.office.fang.com/zu/house/c1150-i31/']
        url = 'https://cd.office.fang.com/zu/house/'
