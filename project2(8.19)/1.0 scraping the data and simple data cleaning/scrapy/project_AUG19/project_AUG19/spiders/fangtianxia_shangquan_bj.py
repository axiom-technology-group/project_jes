...
class LianjiaershoubjSpider(CrawlSpider):
    name = 'fangtianxiashangquanbj'
    allowed_domains = ['shop.fang.com']
    start_urls = ['https://shop.fang.com/shou/house/i31/']
    ua = UserAgent()
    ...
    def parse(self, response):
        ...
        urlstring = 'https://shop.fang.com/shou/house/' 
    ...
    def parse_small(self, response):
        for link in response.xpath("//dt[@class = 'floatl']//a/@href").extract():
            ...
            totallink = 'https://shop.fang.com'+ str(link)
