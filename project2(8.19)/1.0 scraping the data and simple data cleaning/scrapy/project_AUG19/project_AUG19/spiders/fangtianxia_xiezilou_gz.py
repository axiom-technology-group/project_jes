...
class LianjiaershoubjSpider(CrawlSpider):
    name = 'fangtianxiaxiezilougz'
    allowed_domains = ['gz.office.fang.com']
    start_urls = ['https://gz.office.fang.com/shou/house/i31/']
    ua = UserAgent()
    ...
    def parse_big(self, response):
        ...
        try:
            ...
            num = int(response.xpath('//div[@class="fanye gray6"]/span/text()').extract_first()[1:-1])
    ...
    def parse_small(self, response):
        ...
        for link in response.xpath("//p[@class = 'title']//a/@href").extract():
            ...
            links.append('https://gz.office.fang.com'+ str(link))
