...
class ChinadailySpider(CrawlSpider):
    ...
    Rule(LinkExtractor(allow=r'cn.chinadaily.com.cn/',deny=("www")), follow=True),
   ]
    ...
    def parse_item(self, response):
        ...
        #getting the column
        item["column"] = response.xpath("/html/body/div[2]/div/div[3]/div[2]/a[1]/text()").extract_first().strip()
