...
from chouti.items import chinadailyItemLoader,chinadailyItem
...
class ChinadailyEnSpider(CrawlSpider):
    ...
    start_urls = ['https://www.chinadaily.com.cn']
    ...
    Rule(LinkExtractor(allow=r'www.chinadaily.com.cn/',deny=("www")), follow=True),
   ]
    ...
    def parse_item(self, response):
        ...
        s = response.xpath('/html/body/div[2]/div[3]/span[1]/text()').extract()[0].strip()
        s1 = s.split('Updated:')
        ...
        #getting the title
        item["title"] = response.xpath('/html/body/div[2]/div[2]/h1/text()').extract_first()
        ...
        #getting the column
        item["column"] = response.xpath("/html/body/div[2]/div[2]/h1/text()").extract_first().strip()
